        ...
        <div class="mx-auto max-w-screen-xl">
            <form action="{{ route('pegawai.store') }}" method="POST" class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" id="is_active" class="w-4 h-4 text-green-600 border-gray-300 rounded" {{ old('is_active', true) ? 'checked' : '' }}>
